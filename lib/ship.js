(function () {
  ...
  Ship.prototype.power = function () {
    return setInterval(this.increasePower.bind(this), 100);
  };

  Ship.prototype.stopPower = function (id) {
    console.log(id);
    clearInterval(id);
  };
  ...
  Ship.prototype.increasePower = function () {
    ...
    var vectors = Asteroids.Util.getVectors(this.dir*(Math.PI/180));
  ...
  Ship.prototype.stopRotation = function () {
    clearInverval(this.rotationInverval);
  }
