(function () {
  ...
  Ship.prototype.draw = function (context) {
    ...
    context.translate(Ship.RADIUS, Ship.RADIUS);
  ...
  Ship.prototype.bulletPos = function () {
    ...
    var newX = (vectors[0] * this.radius) + (this.pos[0] + this.radius);
    var newY = (vectors[1] * this.radius) + (this.pos[1] + this.radius);
    return [newX, newY];
  };
})();
