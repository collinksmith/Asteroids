(function () {
  ...
  Game.BACKGROUND_IMG.src = './assets/space.jpg';
  ...
  Game.prototype.collidesWithAsteroid = function(obj) {
    ...
    this.asteroids.forEach(function (asteroid) {
      if (asteroid.isCollidedWith(obj, true)) {
        collides = true;
      }
    });
    return collides;
  ...
  Game.prototype.draw = function (context) {
    ...
    context.drawImage(Game.BACKGROUND_IMG, 0, 0, Game.DIM_X, Game.DIM_Y);
  ...
  Game.prototype.drawInstructions = function(ctx) {
    ...
    ctx.fillText("Rotate: a/d or ←/→", 20, Game.DIM_Y - 80);
    ctx.fillText("Forward: w or ↑", 20, Game.DIM_Y - 50);
    ctx.fillText("Shoot: space", 20, Game.DIM_Y - 20);
    ctx.restore();
  };

  Game.prototype.drawLives = function(ctx) {
    ctx.fillText("Lives: " + this.lives, Game.DIM_X - 240, Game.DIM_Y - 80);
  };

  Game.prototype.drawScore = function(ctx) {
    ctx.fillText("Score: " + this.score, Game.DIM_X - 240, Game.DIM_Y - 20);
  };
